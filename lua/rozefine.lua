local M = {}
local config = require("rozefine.config")

local function set_highlights()
	local utilities = require("rozefine.utilities")
	local palette = require("rozefine.palette")
	...
	local legacy_highlights = {
		...
		["@text.diff.add"] = { fg = palette.foam, bg = groups.git_add, blend = 20 },
		["@text.diff.delete"] = { fg = palette.love, bg = groups.git_delete, blend = 20 },
	...
	local default_highlights = {
		...
		Cursor = { bg = palette.text, fg = palette.base },
		...
		DiffDelete = { bg = groups.git_delete, nocombine = true },
		...
		["@diff.plus"] = { fg = palette.foam, bg = groups.git_add, blend = 20 },
		["@diff.minus"] = { fg = palette.love, bg = groups.git_delete, blend = 20 },
		["@diff.delta"] = { fg = palette.pine, bg = groups.git_change, blend = 20 },
		...
		GitSignsAdd = { fg = palette.foam, bg = "NONE" },
		GitSignsChange = { fg = palette.pine, bg = "NONE" },
		GitSignsDelete = { fg = palette.love, bg = "NONE" },
		SignAdd = { fg = palette.foam, bg = "NONE" },
		SignChange = { fg = palette.pine, bg = "NONE" },
		SignDelete = { fg = palette.love, bg = "NONE" },
		...
		NvimTreeFileRenamed = { fg = palette.foam },
		NvimTreeFileStaged = { fg = palette.foam },
		...
		NvimTreeGitRenamed = { fg = palette.foam },
		NvimTreeGitStaged = { fg = palette.foam },
		...
		NeoTreeGitAdded = { fg = palette.foam },
		...
		NeoTreeGitRenamed = { fg = palette.foam },
		...
		NeogitChangeAdded = { fg = palette.foam, bold = styles.bold, italic = styles.italic },
		NeogitChangeBothModified = { fg = palette.pine, bold = styles.bold, italic = styles.italic },
		NeogitChangeCopied = { fg = groups.git_untracked, bold = styles.bold, italic = styles.italic },
		NeogitChangeDeleted = { fg = palette.love, bold = styles.bold, italic = styles.italic },
		NeogitChangeModified = { fg = palette.pine, bold = styles.bold, italic = styles.italic },
		NeogitChangeNewFile = { fg = palette.foam, bold = styles.bold, italic = styles.italic },
		NeogitChangeRenamed = { fg = palette.foam, bold = styles.bold, italic = styles.italic },
		NeogitChangeUpdated = { fg = palette.pine, bold = styles.bold, italic = styles.italic },
		...
		MiniDepsChangeAdded = { fg = palette.foam },
		MiniDepsChangeRemoved = { fg = palette.love },
		...
		MiniDiffOverAdd = { fg = palette.foam, bg = groups.git_add, blend = 20 },
		MiniDiffOverChange = { fg = palette.pine, bg = groups.git_change, blend = 20 },
		MiniDiffOverContext = { bg = palette.surface },
		MiniDiffOverDelete = { fg = palette.love, bg = groups.git_delete, blend = 20 },
		MiniDiffSignAdd = { fg = palette.foam },
		MiniDiffSignChange = { fg = palette.pine },
		MiniDiffSignDelete = { fg = palette.love },
		...
		GrugFarResultsChangeIndicator = { fg = palette.pine },
		GrugFarResultsRemoveIndicator = { fg = palette.love },
		GrugFarResultsAddIndicator = { fg = palette.foam },
		...
		DiffviewFilePanelInsertions = { fg = palette.foam },
		DiffviewFilePanelDeletions = { fg = palette.love },
		...
		DiffviewStatusAdded = { fg = palette.foam },
		DiffviewStatusUntracked = { fg = groups.git_untracked },
		DiffviewStatusModified = { fg = palette.pine },
		DiffviewStatusRenamed = { fg = palette.foam },
		DiffviewStatusCopied = { fg = groups.git_untracked },
		DiffviewStatusTypeChange = { fg = palette.pine },
		DiffviewStatusUnmerged = { fg = palette.pine },
		DiffviewStatusUnknown = { fg = palette.love },
		DiffviewStatusDeleted = { fg = palette.love },
		DiffviewStatusBroken = { fg = palette.love },
	...
	if config.options.enable.terminal then
		...
		augroup rozefine
			...
			autocmd ColorSchemePre * autocmd! rozefine
		augroup END
		]])
	end
end
